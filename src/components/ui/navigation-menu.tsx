  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[120]">
      <motion.nav
        ...
        className={cn(
          "flex items-center overflow-hidden rounded-full border border-border/20 bg-background/80 shadow-lg backdrop-blur-md h-12 transition-all duration-300",
          !isExpanded && "cursor-pointer justify-center"
        )}
      >
        <motion.div
          variants={logoVariants}
          className="flex-shrink-0 flex items-center font-semibold pl-4 pr-2 text-primary"
        >
